...
LOCATION.ONFIELD = (LOCATION.MZONE | LOCATION.SZONE | LOCATION.FZONE | LOCATION.PZONE);
...
export { CTOS, STOC, LOCATION, MSG, ERROR, PLAYERCHANGE, HINT, POS, QUERY, PHASE, COMMAND, EDESC };